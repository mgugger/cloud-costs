...
class TestMultipleAdditionalInvoicePositionNegative(object):
    @pytest.mark.dependency()
    def test_account_discount_no_negative_amounts(self, mocker, db):
        ...
        service_customer1 = ServiceCustomer.create(
            name = 'Customer1',
            service_description = 'ShouldNotHaveAnyCosts',
        ...
        Account.update(service_customer=None).execute()
        ...
        assert_invoice(invoices[0], csv, 2)
