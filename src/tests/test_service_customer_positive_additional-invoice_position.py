...
from src.model import Account, ServiceCustomer, AdditionalInvoicePosition, Invoice, ServiceComponent, ServiceComponent2Service, Service, DataImport, Resource
from src.invoicing import Invoicer, Mailer
from src.constants import Constants
from src.tests.helper import assert_invoice

class TestPositiveAdditionalInvoicePosition(object):
    ...
    def test_account_discount(self, mocker, db):
        ...
        discount1 = AdditionalInvoicePosition.create(
            reason = "Test Additional Position",
            amount = 2,
    ...
    @pytest.mark.dependency()
    def test_invoice_additional_position(self, mocker, db):        
        ...
        service_customer_discount = AdditionalInvoicePosition.create(
        ...
        assert_invoice(invoices[0], csv, 207)
    ...
    @pytest.mark.dependency(depends=['TestPositiveAdditionalInvoicePosition::test_invoice_additional_position'])
